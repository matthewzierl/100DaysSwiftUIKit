...
//        let trigger = UNCalendarNotificationTrigger(dateMatching: dateComponents, repeats: true)
    ...
    func registerCategories() {
        ...
        let other = UNNotificationAction(identifier: "other", title: "destruction", options: .destructive)
        
        /*
            identifier: must match same category identifier that we made above
         */
        let category = UNNotificationCategory(identifier: "alarm", actions: [show, other], intentIdentifiers: [], options: [])
