...
//            finalURL = "https://github.com/leinstay/steamdb/raw/main/steamdb.json"
//        } else { // tag == 1
...
//        DispatchQueue.global(qos: .userInitiated).async { // closure for this call
//            [weak self] in
//            if let url = URL(string: urlString) { // convert string to URL
//                if let data = try? Data(contentsOf: url) { // convert URL to data instance
//                    // we're okay to parse!
...
//        }
    ...
    @objc func showCredits() {
        let ac = UIAlertController(title: "Credits", message: "This information is provided by \(finalURL!)", preferredStyle: .alert)
